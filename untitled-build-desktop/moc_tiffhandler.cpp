...
#include "../../Development/QtProject/Ink/untitled/tiffhandler.h"
...
void TIFFHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        TIFFHandler *_t = static_cast<TIFFHandler *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData TIFFHandler::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TIFFHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TIFFHandler,
      qt_meta_data_TIFFHandler, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TIFFHandler::getStaticMetaObject() { return staticMetaObject; }
